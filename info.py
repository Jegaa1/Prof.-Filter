...
# PyroClient Setup 
API_ID = int(environ['API_ID', '1923471'])
API_HASH = environ['API_HASH', 'fcdc178451cd234e63faefd38895c991']
BOT_TOKEN = environ['BOT_TOKEN', "6023399726:AAH0hkqGnwGnUX0-DFQ4CXF_7gihNI2SsTo"]
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1923471').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001188070894 -100169224324 -1002461730224').split()]
